...
namespace XunitShould
{
    internal static partial class Should
    {
        ...
        public static void ShouldBeAssignableTo(this object @object,
                                                Type type)
        {
            Assert.IsAssignableFrom(type,
                                    @object);
        }
        ...
        /// <exception cref="IsTypeException">Thrown when the object is not the given type</exception>
        public static void ShouldBeInstanceOf(this object @object,
                                              Type expectedType)
        {
        ...
        /// <exception cref="IsTypeException">Thrown when the object is the given type</exception>
        public static void ShouldNotBeInstanceOf(this object @object,
                                                 Type expectedType)
        {
            Assert.IsNotType(expectedType,
                             @object);
        }
    }
}