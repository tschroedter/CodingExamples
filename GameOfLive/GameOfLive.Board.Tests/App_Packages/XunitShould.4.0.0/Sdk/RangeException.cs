...
namespace XunitShould.Sdk
{
    internal abstract class RangeException : XunitException
    {
        ...
        /// <remarks></remarks>
        protected RangeException(object actual,
                                 object low,
                                 bool lowInclusive,
                                 object high,
                                 bool highInclusive,
        ...
        /// <inheritdoc />
        protected RangeException(SerializationInfo info,
                                           ...
                                           StreamingContext context)
        {
            ...
            info.AddValue("Low",
                          _low);
            info.AddValue("LowInclusive",
                          _lowInclusive);
            info.AddValue("High",
                          _high);
            info.AddValue("HighInclusive",
                          _highInclusive);
