...
namespace XunitShould.Sdk
{
    ...
    internal class EnumerableEqualException : XunitException
    {
        ...
        public EnumerableEqualException(object expected,
                                        object actual,
                                        int atIndex,
                                        int expectedCount,
                                        int actualCount)
        ...
        /// <inheritdoc />
        protected EnumerableEqualException(SerializationInfo info,
                                           ...
                                           StreamingContext context)
        {
            ...
            info.AddValue("ExpectedCount",
                          _expectedCount);
            info.AddValue("ActualCount",
                          _actualCount);
            info.AddValue("AtIndex",
                          _atIndex);
            info.AddValue("Expected",
                          _expected);
            info.AddValue("Actual",
                          _actual);
