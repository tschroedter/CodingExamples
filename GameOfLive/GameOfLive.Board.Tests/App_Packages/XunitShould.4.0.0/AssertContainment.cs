...
namespace XunitShould
{
    internal static partial class Should
    {
        ...
        public static void ShouldContain <T>(this IEnumerable <T> series,
                                             T expected)
        {
        ...
        public static void ShouldNotContain <T>(this IEnumerable <T> series,
                                                T expected)
        {
                                              ...
                                              StringComparison comparisonType = StringComparison.CurrentCulture)
        {
            ...
            string temp = actual.Substring(0,
                                           begining.Length);
            Assert.NotEqual(begining,
                            temp,
                            comparisonType.GetComparer());
        }
                                           ...
                                           StringComparison comparisonType = StringComparison.CurrentCulture)
        {
            if ( actual.Length < begining.Length )
            {
                throw new EqualException(begining,
                                         actual);
            }
            string temp = actual.Substring(0,
                                           begining.Length);
            Assert.Equal(begining,
                         temp,
                         comparisonType.GetComparer());
        }
    }
